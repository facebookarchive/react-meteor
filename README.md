...
```
git clone https://github.com/LumaPictures/react-meteor.git
```
...
```
cd path/to/my-app/
echo luma:react >> .meteor/packages
git clone https://github.com/LumaPictures/react-meteor.git packages/react
```
